...
func incrementSteps(value: Int)
{
    let stepCount = steps + 1
    steps = stepCount
    print(stepCount)
}

incrementSteps(value : steps)
incrementSteps(value: steps)
incrementSteps(value: steps)
/*:
...
func progressUpdate(value : Double)
{
    if value < goal * 0.1
    {
        print("You're off to a good start.")
    }
    else if value > 1001 && value < goal * 0.5
    {
        print("You're almost halfway there!")
    }
    else if value > 5001 && value < goal * 0.9
    {
        print("You're over halfway there!")
    }
    else if value > goal * 0.9 && value < goal
    {
...
progressUpdate(value: Double(steps))
progressUpdate(value: 9002)
